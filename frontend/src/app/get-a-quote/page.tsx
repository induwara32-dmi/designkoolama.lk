...
export default async function Page({searchParams}:{searchParams:Promise<{service?:string;package?:string}>}){const query=await searchParams;return <QuotePage service={query.service} packageName={query.package}/>}
