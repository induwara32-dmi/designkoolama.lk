...
export default async function Page(){try{const[projects,ui]=await Promise.all([loadPortfolio(portfolioProjects),loadPageSection<RouteUiContent>("route-content","ui",routeUiContent)]);return <PortfolioPage projects={projects} copy={ui.portfolio}/>}catch{return <ContentUnavailable/>}}
